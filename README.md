...
- There are many errors this step may reveal.
  ...
  - If you forgot to install a package, you see an error like one of the following.
 
  <p align="center"> <img src="./readme_files/bookdown_noInstall.PNG" alt="bookdown no install" width="400"/> </p>
...
- Run 'renv::snapshot()'.
  ...
  <p align="center"> <img src="./readme_files/renv_snapshotRemain.PNG" alt="renv snapshot remain" width="400"/> </p>
